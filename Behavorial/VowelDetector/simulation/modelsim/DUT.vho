...
SIGNAL \add_instance|o~combout\ : std_logic;
SIGNAL \input_vector~combout\ : std_logic_vector(3 DOWNTO 0);
SIGNAL \add_instance|ALT_INV_o~combout\ : std_logic;
...
ww_devclrn <= devclrn;
ww_devpor <= devpor;
\add_instance|ALT_INV_o~combout\ <= NOT \add_instance|o~combout\;
...
\add_instance|o\ : maxv_lcell
-- Equation(s):
-- \add_instance|o~combout\ = (\input_vector~combout\(0)) # (\input_vector~combout\(1) $ (((\input_vector~combout\(2) & \input_vector~combout\(3)))))
...
PORT MAP (
	...
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	combout => \add_instance|o~combout\);
...
-- pragma translate_on
PORT MAP (
	datain => \add_instance|ALT_INV_o~combout\,
	oe => VCC,
